            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    <motion.div variants={floatingVariantsReverse} animate="animate" className="absolute bottom-8 right-8 md:bottom-12 md:right-16 w-16 md:w-24 opacity-80 pointer-events-none hidden sm:block">
                        <img src="/images/Group-white.png" alt="" className="w-full h-auto object-contain" />
                    </motion.div>
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
                        ...
                        >
                            Real Projects. <span className="text-[#212121]">Real Progress.</span> <br className="hidden md:block" />
                            Real You.
                        </motion.h1>
                        ...
                        >
                            A showcase of profitable skills and future-focused projects, built to turn learning into lasting impact.
                        </motion.p>
...
export default CTASectionPortfolio;